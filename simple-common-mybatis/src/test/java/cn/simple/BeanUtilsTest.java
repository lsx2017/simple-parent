...
//
//import com.simple.common.utils.User;
//
//public class BeanUtilsTest {
//	/**
//	 * @Name: testSetProperty
//	 * @Description: 1、设置Bean对象的单个属性 public static void setProperty(Object bean,
//	 *               String name, Object value) = public static void
...
//		// 设置Date类型的属性
//		// 异常信息：DateConverter does not support default String to 'Date'
//		// conversion.
//		// 注册String->日期类型转换器
//
//		// 设置数组类型的属性
...
//		// 将Map集合注入到JavaBean
//
//		user.setBirthday(new SimpleDateFormat("yyyy-MM-dd").parse("2016-12-11"));
...
//	/**
//	 * @Name: testPupulate
//	 * @Description: 2、将Map<String, Object>集合中的内容设置到JavaBean的属性上 说明：
//	 *               Map的key：必须与JavaBean的属性名称相同； Map的value：注入到JavaBean的属性； 备注：
