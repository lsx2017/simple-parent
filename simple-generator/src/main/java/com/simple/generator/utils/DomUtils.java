...
public class DomUtils {
     ...
     * @return      返回文档对象 
     */  
    public static Document getDocByPath(String path) {  
        if (null == path) {  
            return null;  
        }  
     ...
     */  
    public static Document getDocByXmlStr(String xmlStr) throws DocumentException{  
    	Document document = null;
     ...
     * @return      返回所有的子节点 
     */  
    public static List<Element> elements(Element node) {  
        if (null == node) {  
            return null;  
        }  
     ...
     */  
    @SuppressWarnings("unchecked")
	public static List<Element> elements(Element node, String childNodeName) {  
        if (null == node) {  
            return null;  
        }  
        List<Element> lists = null;
        if(StringUtils.isNotEmpty(childNodeName)) {
        	lists = node.elements(childNodeName); 
        }
        return lists;  
    }  
     ...
     * 获取指定节点的子节点 
     * @param node          父节点 
     * @param childNodeName 指定名称的子节点 
     * @return              返回指定的子节点 
     */  
    public static Element element(Element node, String childNodeName){  
        if(null == node || StringUtils.isEmpty(childNodeName)){  
            return null;  
        }  
        return node.element(childNodeName);  
    }  
	   ...
	   * @param attrName  需要获取的属性值名称
	   * @return          返回属性的值 
	   */  
	  public static String getAttrVal(Element node, String attrName){  
		  if(null == node || StringUtils.isEmpty(attrName)){  
	          return "";  
	      }  
     ...
     * @return
     */
    public static Map<String, String> getAttrVals(Element node, String...args){  
     ...
     * @return 新增节点 
     */  
    public static Element addChildNode(Element parent, String childName, String childValue) {  
     ...
     * @return 经过解析后的xml字符串 
     */  
    public static String docToStr(Document document, String charset) {  
     ...
     * @return 
     */  
    public static String docToStrNoDeclaredHeader(Document document, String charset) {  
        String xml = docToStr(document, charset);  
     ...
     * @return 
     */  
    public final static String getText(Element el, String tag) {  
        Element element = el.element(tag);  
     ...
     * @return 
     */  
    public final static String getTextTrim(Element el, String tag) {  
        Element element = el.element(tag);  
        if (element != null) {
