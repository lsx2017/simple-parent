...
public class HibernateWebUtils {
	...
	public static <T> void mergeByCheckedObjects(final Collection<T> srcObjects, final Collection<T> targetObjects,
			final String idName) throws Exception {
		...
		while (srcIterator.hasNext()) {
			T element = srcIterator.next();
			Object srcId = PropertyUtils.getProperty(element, idName);
			
			boolean flag = true;
			Iterator<T> targetIterator = targetObjects.iterator();
			while(targetIterator.hasNext()){
				T target = targetIterator.next();
				Object targetId = PropertyUtils.getProperty(target, idName);
	 ...
	 */
	public static List<PropertyFilter> buildPropertyFilters(final ServletRequest request) {
		return buildPropertyFilters(request, "filter_");
	}
	
	public static <T> void mergeByCheckedObjects(final Collection<T> srcObjects, final Collection<T> targetObjects) throws Exception {
		mergeByCheckedObjects(srcObjects, targetObjects, "id");
	}
	...
	public static List<PropertyFilter> buildPropertyFilters(final NativeWebRequest request) {
		return buildPropertyFilters(request, "filter_");
	}
	
	public static List<PropertyFilter> buildPropertyFilters(final NativeWebRequest request, final String filterPrefix) {
